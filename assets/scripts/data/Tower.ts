...
export const TOWER_FLOORS: TowerFloorDef[] = [
    ...
    { floor: 6, guardName: '疾风射手', title: '筑基一层', level: 7, weapon: WeaponType.Bow, skillIds: ['jichujianshu'], statScale: 1.42, xp: 45 },
    { floor: 7, guardName: '疾风射手', title: '筑基二层', level: 8, weapon: WeaponType.Bow, skillIds: ['jichujianshu', 'zhuifengjian'], statScale: 1.51, xp: 50 },
    ...
    { floor: 9, guardName: '铁壁武僧', title: '筑基四层', level: 10, weapon: WeaponType.Spear, skillIds: ['jichuqiang'], statScale: 1.71, xp: 65 },
    ...
    { floor: 11, guardName: '幻音仙子', title: '金丹一层', level: 13, weapon: WeaponType.Guqin, skillIds: ['jichuqinyin'], statScale: 1.93, xp: 85 },
    ...
    { floor: 13, guardName: '黑风刀客', title: '金丹三层', level: 15, weapon: WeaponType.Blade, skillIds: ['jichudao', 'pojundao'], statScale: 2.17, xp: 100 },
    ...
    { floor: 15, guardName: '紫霄真人', title: '金丹圆满', level: 18, weapon: WeaponType.Sword, skillIds: ['luoyingjianfa', 'poshijiujian'], statScale: 2.44, xp: 130, dropMartial: 'chunyangong', isBoss: true },
    { floor: 16, guardName: '落月弓圣', title: '元婴一层', level: 19, weapon: WeaponType.Bow, skillIds: ['jichujianshu', 'zhuifengjian'], statScale: 2.58, xp: 135 },
    { floor: 17, guardName: '落月弓圣', title: '元婴二层', level: 20, weapon: WeaponType.Bow, skillIds: ['zhuifengjian', 'luorishenjian'], statScale: 2.73, xp: 145 },
    ...
    { floor: 19, guardName: '枪王·岳擎天', title: '元婴四层', level: 23, weapon: WeaponType.Spear, skillIds: ['bainiaoqiangjue'], statScale: 3.06, xp: 170 },
    { floor: 20, guardName: '塔主·墨天行', title: '元婴圆满', level: 26, weapon: WeaponType.Sword, skillIds: ['poshijiujian', 'luoyingjianfa', 'luorishenjian'], statScale: 3.24, xp: 220, dropWeapon: 'sword', dropMartial: 'zixiashengong', isBoss: true },
];
