...
export const TOWER_FLOORS: TowerFloorDef[] = [
    ...
    { floor: 6, guardName: '疾风射手', title: '筑基一层', level: 7, weapon: WeaponType.Bow, skillIds: ['jichujianshu'], statScale: 1.42, xp: 45, dropMartial: 'zhuifengjian' },
    ...
    { floor: 9, guardName: '铁壁武僧', title: '筑基四层', level: 10, weapon: WeaponType.Spear, skillIds: ['jichuqiang'], statScale: 1.71, xp: 65, dropMartial: 'panlongqiang' },
    ...
    { floor: 11, guardName: '幻音仙子', title: '金丹一层', level: 13, weapon: WeaponType.Guqin, skillIds: ['jichuqinyin'], statScale: 1.93, xp: 85, dropMartial: 'qingxinqu' },
    ...
    { floor: 13, guardName: '黑风刀客', title: '金丹三层', level: 15, weapon: WeaponType.Blade, skillIds: ['jichudao', 'pojundao'], statScale: 2.17, xp: 100, dropMartial: 'duanshuiliu' },
