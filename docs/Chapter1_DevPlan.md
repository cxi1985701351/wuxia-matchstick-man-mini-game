...
| P2 地图区域系统 | 区域数据/传送节点/地面/边界钳制（设计见 `docs/Chapter1_P2_MapDesign.md`） | —（可并行） | 1.5~2 天 | 10 区域可步行/传送；NPC 归位正确 |
...
| P5 流程整合 | 序章 gating/教学/三钩子/存档迁移 | P3、P4 | 1~1.5 天 | 新档 20~25 分钟三幕；旧档不崩 ✅ 2026-08-17：见 GDD §13.18 |
| P6 测试调优 | 平衡脚本验证/难度曲线/时长实测/润色 | P5 | 1~2 天 | 伞/拳 CD 曲线递增；时长达标 ✅ 2026-08-18：见 GDD §13.22~13.24 |
